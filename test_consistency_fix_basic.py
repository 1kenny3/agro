#!/usr/bin/env python3
"""
Тест для проверки согласованности результатов между основными типами анализа
Проверяем что одно и то же изображение дает одинаковые результаты классификации
в основных эндпоинтах: /classify и /analyze
"""
...
def main():
    ...
    print("в основных эндпоинтах API")
    
    # Создаем тестовое изображение кукурузы
    print("\n🌽 Создание тестового изображения кукурузы...")
    test_image = create_test_corn_image()
    
    # Определяем основные эндпоинты для тестирования
    endpoints = [
    ...
    if match:
        print("🎉 ОСНОВНЫЕ ЭНДПОИНТЫ ДАЮТ СОГЛАСОВАННЫЕ РЕЗУЛЬТАТЫ!")
        print("✅ Проблема с различными типами анализа ИСПРАВЛЕНА")
        print("📝 Примечание: Классификация культуры и комплексный анализ")
        print("   теперь используют одинаковую логику выбора классификатора")
    else:
...
if __name__ == "__main__":
    print("🔧 Тест согласованности основных эндпоинтов")
    ...
    if success:
        print("\n✅ Тест ПРОЙДЕН!")
        print("🎯 Основная проблема исправлена - классификация культуры")
        print("   и комплексный анализ теперь согласованы!")
    else:
        print("\n❌ Тест ПРОВАЛЕН!") 